...
public class HomeFragment extends Fragment implements OnMapReadyCallback, ZLocationCallback {
    ...
    public void onCoordinatesIdentified(Location loc) {
        ...
        if(loc != null && prefs != null) {
            ...
            ((Home) activity).setLatitudeStart(lat);
            ((Home) activity).setLongitudeStart(lon);
            refreshMap();
        }
